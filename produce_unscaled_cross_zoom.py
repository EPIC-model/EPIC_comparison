from epic_utils import produce_limited_cross_section, get_limited_coordinates
...
for boxnr, box in enumerate(boxes):
    xp, yp, zp = get_limited_coordinates(
        epic_input_file_name, cross_type="xz", box=box, ndir=2048
    )
    ...
    xp, yp, zp = get_limited_coordinates(
        epic_input_file_name, cross_type="xz", box=box, ndir=4096
    )
    xz_cross = produce_limited_cross_section(
        epic_input_file_name,
        xp,
