...
for findex, ax in enumerate(grid):
    ...
    if findex < len(files):
        ...
        ax.axis("off")
add_annotation(grid[0], "Parcels", [0.5, 1.1], ha="center")
add_annotation(grid[1], "Supergaussian (3x)", [0.5, 1.1], ha="center")
add_annotation(grid[2], "Supergaussian (5x)", [0.5, 1.1], ha="center")
add_annotation(grid[0], "EPIC", [-0.26, 0.5], va="center", ha="right")
add_annotation(grid[3], "MPIC", [-0.26, 0.5], va="center", ha="right")
