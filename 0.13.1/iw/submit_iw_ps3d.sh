...
#srun --unbuffered --distribution=block:block --hint=nomultithread ${PS3D_DIR}/bin/ps3d --config iw_ps3d_12.config

#srun --unbuffered --distribution=block:block --hint=nomultithread ${PS3D_DIR}/bin/ps3d --config iw_ps3d_16.config

#srun --unbuffered --distribution=block:block --hint=nomultithread ${PS3D_DIR}/bin/ps3d --config iw_ps3d_24.config

#srun --unbuffered --distribution=block:block --hint=nomultithread ${PS3D_DIR}/bin/ps3d --config iw_ps3d_32.config

srun --unbuffered --distribution=block:block --hint=nomultithread ${PS3D_DIR}/bin/ps3d --config iw_ps3d_64.config
