#!/usr/bin/env python
#
# python iw_analytic.py --k 0.5 --l 0.5 --m 1.0 --N 2 --f 1.0 --nx 256 --ny 256 --nz 64 --what 0.001
...
try:
    ...
    ncf.open('iw_analytic_' + str(nx) + 'x' + str(ny) + 'x' + str(nz) + '.nc')
    ...
    for l, t in enumerate(times):
        ...
        ncf.add_field('buoyancy', buoy, unit='m/s^2', long_name='buoyancy', time_index=l)
        ncf.add_field('x_vorticity', xi, unit='1/s', long_name='x-vorticity', time_index=l)
        ncf.add_field('y_vorticity', eta, unit='1/s', long_name='y-vorticity', time_index=l)
        ncf.add_field('z_vorticity', zeta, unit='1/s', long_name='z-vorticity', time_index=l)

    ncf.add_axis('t', times)
