...
srun --unbuffered --distribution=block:block --hint=nomultithread ${PS3D_DIR}/bin/ps3d --config rt_ps3d_32.config
srun --unbuffered --distribution=block:block --hint=nomultithread ${PS3D_DIR}/bin/ps3d --config rt_ps3d_48.config
srun --unbuffered --distribution=block:block --hint=nomultithread ${PS3D_DIR}/bin/ps3d --config rt_ps3d_64.config
srun --unbuffered --distribution=block:block --hint=nomultithread ${PS3D_DIR}/bin/ps3d --config rt_ps3d_96.config

#srun --unbuffered --distribution=block:block --hint=nomultithread ${PS3D_DIR}/bin/ps3d --config rt_ps3d_128.config
(epic-env) mf248@ln01:/work/e710/e710/mf248/ps3d-paper-runs> cat submit_rt_ps3d.sh~ 
#!/bin/bash --login
