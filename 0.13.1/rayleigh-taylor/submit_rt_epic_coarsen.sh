...
# coarsen from 384 to 128
#srun --unbuffered --distribution=block:block --hint=nomultithread ${EPIC_DIR}/bin/coarsen --filename epic_rt_384_fields.nc --shrink 3

#mv crse_3_epic_rt_384_fields.nc coarsened/crse_128_epic_rt_384_fields.nc

# coarsen from 384 to 192
srun --unbuffered --distribution=block:block --hint=nomultithread ${EPIC_DIR}/bin/coarsen --filename epic_rt_384_fields.nc --shrink 2

mv crse_2_epic_rt_384_fields.nc coarsened/crse_192_epic_rt_384_fields.nc
